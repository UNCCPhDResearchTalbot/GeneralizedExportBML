...
var locationarray = ["CENTER", "BACK", "UPSTAGE", "DOWNSTAGE", "FORWARD", "BACKWARD", "STAGELEFT", "STAGERIGHT", "RIGHT", "CENTERBACKSTAGE", "AUDIENCE", "LEFT", "IT", "CENTERRIGHT", "TRUNK", "BOX", "CHAIR", "TABLE", "ROOM", "DOOR", "HATBOX"];
var translatedlocationarray = ["CENTER", "/BACK", "UPSTAGE", "DOWNSTAGE", "/FORWARD", "/BACK", "STAGELEFT", "STAGERIGHT", "/RIGHT", "CENTERBACKSTAGE", "AUDIENCE", "/LEFT", "/CURRENT", "CENTERRIGHT", "TRUNK", "BOX", "CHAIR", "TABLE", "/OPPOSITE", "DOOR", "BOX"];

// all characters and pronouns with their translated standardized value
var chararray = [ "HE", "SHE", "WHO", "HIS", "ANYA", "YASHA", "EPIKHODOV", "TROFIMOV", "LOPAKHIN", "VARYA"];
var translatedchararray = [ "/CURRENT", "/CURRENT", "/CURRENT", "/CURRENT", "ANYA", "YASHA", "EPIKHODOV", "TROFIMOV", "LOPAKHIN", "VARYA"];
