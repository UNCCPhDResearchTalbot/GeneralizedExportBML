...
var charprecedence = ["ANYA", "YASHA", "EPIKHODOV", "TROPFIMOV", "LOPAKHIN", "VARYA"];

// all marks, pawns, miscellaneous objects with their translated standardized value
var locationarray = ["CENTER", "BACK", "UPSTAGE", "DOWNSTAGE", "FORWARD", "BACKWARD", "STAGELEFT", "STAGERIGHT", "RIGHT", "CENTERBACKSTAGE", "AUDIENCE", "LEFT", "IT", "CENTERRIGHT", "TRUNK", "BOX", "CHAIR", "TABLE", "DOOR"];
var translatedlocationarray = ["CENTER", "/BACK", "UPSTAGE", "DOWNSTAGE", "/FORWARD", "/BACK", "STAGELEFT", "STAGERIGHT", "/RIGHT", "CENTERBACKSTAGE", "AUDIENCE", "/LEFT", "/CURRENT", "CENTERRIGHT", "TRUNK", "BOX", "CHAIR", "TABLE", "DOOR"];

// all characters and pronouns with their translated standardized value
var chararray = [ "HE", "SHE", "WHO", "HIS", "ANYA", "YASHA", "EPIKHODOV", "TROPFIMOV", "LOPAKHIN", "VARYA"];
var translatedchararray = [ "/CURRENT", "/CURRENT", "/CURRENT", "/CURRENT", "ANYA", "YASHA", "EPIKHODOV", "TROPFIMOV", "LOPAKHIN", "VARYA"];

// all physical locations on stage that person would need to move to, not relative position
var markarray = ["CHAIR", "TABLE"];
...
// CJT 7/7/16					return gravedigger1.name;
	...
	function isPropLine(data) {
		console.log("isPropLine, data="+data+"+");
		var temp = data.replace(" ", "");
	...
	function calcPosition(data, actor) {
		console.log("in CalcPosition, data="+data+": actor="+actor.name);
...
// CJT 7/7/16					return gravedigger1.name;
	...
	function isMvmtLine(data) {
		console.log("in isMvmtLine, data="+data);
		if(data[0] == '(') {
			return true;
		}
		return false;
	...
	function isActionWord(word) {
		console.log("in isActionWord, word="+word);
	...
	function setmvmtlines(thisLine, num, mynum, word, type, basemsgnum) {
		console.log("in setmvmtlines, thisline, num, mynum, word, type, basemsgnum="+thisLine+","+num+","+mynum+","+word+","+type+","+basemsgnum);
	...
	function translate(thisLine, num, firstverb, actor, target, msgnum) {
		console.log("in translate: thisline, num, firstverb, actor, target, msgnum="+thisLine+","+num+","+firstverb+","+actor.name+","+target.name+","+msgnum);
		var best = null;
	...
	function checkmovetarget(actor, msgnum, target, callbackFunc) {
		console.log("in checkmovetarget: actor, msgnum, target="+actor.name+","+msgnum+","+target.name);
	...
	function planmovement(thisLine, num, basemsgnum) {
		console.log("in planmovement: thisline, num, basemsgnum="+thisLine+","+num+","+basemsgnum);
	...
	function parseMvmt(data, thisLine, num, basemsgnum) {
		console.log("in parseMvmt: data, thisline, num, basemsgnum="+data+","+thisLine+","+num+","+basemsgnum);
		var actor = null;
		var target = null;
...
// **************************************************************************************
	...
	var chair = new Pawn('CHAIR', 861.14, 857.17, '0, 0, 0', '234, 234, 234', false);
	var table = new Pawn('TABLE', 483.36, 857.17, '0, 0, 0', '234, 234, 234', false);
